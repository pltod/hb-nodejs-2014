...
var beerAndFries = require("../src/beerAndFries.js").beerAndFries;
...
exports.testBeerAndFriesScenario6 = function(test) {
  var testData = [{
    type: "beer",
    score: 2000
  }, {
  ...
  test.equal(1663190, beerAndFries(testData));
  test.done();
};

exports.testBeerAndFriesScenario7 = function(test) {
  var testData = [{
    type: "beer",
    score: 0
  }, {
  ...
  test.equal(257, beerAndFries(testData));
  test.done();
};